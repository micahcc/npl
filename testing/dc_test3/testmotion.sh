...
# create motion file
echo -163 -92 98 0 0 0 0 0 0 > motion0.rtm
echo -163 -92 98 .1 .2 -0.3 3 2 4 > motion1.rtm
...
nplDistortionCorr -R motion.rtm -a $distimg -d y -m sim.nii.gz -o sim_dc.nii.gz -F sim_dc_field.nii.gz
