...
int main()
{
    ...
    if(distcorDerivTest(0.0001, 0.005, distimg, origimg, 0, 1) != 0)
        return -1;
    if(distcorDerivTest(0.0001, 0.005, distimg, origimg, 1, 0) != 0)
        return -1;
    if(distcorDerivTest(0.0001, 0.005, distimg, origimg, 1, 1) != 0)
        return -1;
    return 0;
}
