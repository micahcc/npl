...
int main()
{
	...
	clock_t c = clock();
	auto out1 = rigidTransform(in, Rx, Ry, Rz, 0, 0, 0);
	c = clock() - c;
...
//    c = clock();
//    auto out2 = dPtrCast<MRImage>(in->copy());
...
//    c = clock();
//    auto out3 = dPtrCast<MRImage>(in->copy());
...
//    c = clock();
//    auto out4 = dPtrCast<MRImage>(in->copy());
