 ...
 *
 * @file dcp_reg_test1.cpp Tests mutual information derivative for deformation
 * when applied to distortion correction using probability maps
 *
 *****************************************************************************/
...
int main()
{
    ...
    if(distcorDerivTest(0.001, 0.31, distimg, origimg) != 0) {
