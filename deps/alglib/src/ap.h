...
alglib::complex operator/(const alglib::complex& lhs, const alglib::complex& rhs);
bool operator==(const alglib::complex& lhs, const alglib::complex& rhs);
bool operator!=(const alglib::complex& lhs, const alglib::complex& rhs);
alglib::complex operator+(const alglib::complex& lhs);
alglib::complex operator-(const alglib::complex& lhs);
alglib::complex operator+(const alglib::complex& lhs, const alglib::complex& rhs);
alglib::complex operator+(const alglib::complex& lhs, const double& rhs);
alglib::complex operator+(const double& lhs, const alglib::complex& rhs);
alglib::complex operator-(const alglib::complex& lhs, const alglib::complex& rhs);
alglib::complex operator-(const alglib::complex& lhs, const double& rhs);
alglib::complex operator-(const double& lhs, const alglib::complex& rhs);
alglib::complex operator*(const alglib::complex& lhs, const alglib::complex& rhs);
