 ...
 */
template <typename T>
void copyCast_help(shared_ptr<const MRImage> in, shared_ptr<MRImage> out)
{
		...
		const size_t* newsize, PixelT newtype)
{
	...
	switch(newtype) {
		case UINT8:
			copyCast_help<uint8_t>(in, out);
			break;
		case INT16:
			copyCast_help<int16_t>(in, out);
			break;
		case INT32:
			copyCast_help<int32_t>(in, out);
			break;
		case FLOAT32:
			copyCast_help<float>(in, out);
			break;
		case COMPLEX64:
			copyCast_help<cfloat_t>(in, out);
			break;
		case FLOAT64:
			copyCast_help<double>(in, out);
			break;
		case RGB24:
			copyCast_help<rgb_t>(in, out);
			break;
		case INT8:
			copyCast_help<int8_t>(in, out);
			break;
		case UINT16:
			copyCast_help<uint16_t>(in, out);
			break;
		case UINT32:
			copyCast_help<uint32_t>(in, out);
			break;
		case INT64:
			copyCast_help<int64_t>(in, out);
			break;
		case UINT64:
			copyCast_help<uint64_t>(in, out);
			break;
		case FLOAT128:
			copyCast_help<long double>(in, out);
			break;
		case COMPLEX128:
			copyCast_help<cdouble_t>(in, out);
			break;
		case COMPLEX256:
			copyCast_help<cquad_t>(in, out);
			break;
		case RGBA32:
			copyCast_help<rgba_t>(in, out);
			break;
		default:
			return NULL;
	}
...
{
	return copyCast(in, in->ndim(), in->dim(), newtype);
}
...
{
	return copyCast(in, newdims, newsize, in->type());
}
